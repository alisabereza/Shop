...
public class SweetDrinks extends Product {
    private ExpirationDate expDate;

    SweetDrinks() {
    };

    SweetDrinks(int id, String name, int number, String description, double price, ExpirationDate expDate) {
    ...
    String show() {
        return "Sweet Drink {" +
                ...
                ", expiration date=" + expDate.show() +
                '}';
    }

    static SweetDrinks registerNewProduct() {
        ...
        return new SweetDrinks(id, name, number, desc, price, new ExpirationDate(manufactureDate, temperature, shelfLife));
    }
}
